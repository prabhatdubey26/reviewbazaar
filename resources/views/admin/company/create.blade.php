...
<div class="row">
    <div class="card">
        <div class="card-body">
            ...
            <a href="{{ route('categories.index') }}" class="btn btn-primary">Company List</a>
            <form class="forms-sample mt-3" action="{{ route('categories.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group row">
                    <div class="col-6">
                        ...
                        <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" multiple>
