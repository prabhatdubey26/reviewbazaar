        ...
        <div class="card-body">
            ...
            <form class="forms-sample mt-3" action="{{ route('company.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('website_url') is-invalid @enderror" id="website_url" name="website_url" placeholder="www.example.com" value="{{ old('website_url') }}">
                    @error('website_url')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('map') is-invalid @enderror" id="map" name="map" placeholder="Enter map" value="{{ old('map') }}">
                    @error('map')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
